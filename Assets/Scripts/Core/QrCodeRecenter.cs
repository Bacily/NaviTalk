...
public class QrCodeRecenter : MonoBehaviour {
    ...
    [SerializeField]
    private GameObject lineOptionPanel;
    [SerializeField]
    ...
    private void SetQrCodeRecenterTarget(string targetText) {
        ...
        if (currentTarget != null) {
            ...
            floorIndicatorscript.writeCurrentFloor(currentTarget.FloorNumber);
        }
    }
    ...
    public void ToggleScanning() {
        ...
        exitButton.SetActive(scanningEnabled);

        lineOptionPanel.SetActive(!scanningEnabled);
        Map.SetActive(!scanningEnabled);
        backButton.SetActive(!scanningEnabled);
